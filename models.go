...
type CommitOrRollbackRestoreRequest struct {
	...
	// Location Settings of the restore operation indicating if the restore is to the Source Location , Paired Region , Cross
// Region.
	LocationSettings *LocationSettings `json:"locationSettings,omitempty"`
...
// LocationSettings - Class encapsulating the locationSettings of the restore - Same Region, Paired Region, Cross Region.
type LocationSettings struct {
	// Location to which the restore is initiated
