...
// LocationMode - Location to which the restore is initiated
type LocationMode string

const (
	LocationModePrimaryOnly LocationMode = "PrimaryOnly"
	LocationModeSecondaryOnly LocationMode = "SecondaryOnly"
)

// PossibleLocationModeValues returns the possible values for the LocationMode const type.
func PossibleLocationModeValues() []LocationMode {
	return []LocationMode{	
